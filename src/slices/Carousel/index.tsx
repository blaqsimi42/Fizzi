...
const Carousel: FC<CarouselProps> = ({ slice }) => {
  const [currentFlavorIndex, setCurrentFlavorIndex] =
  useState(0);
  ...
  return (
    ...
    >
      ...
      absolute inset-0 bg-[#710523] opacity-50" />

      <WavyCircles className="absolute left-1/2 
      top-1/2 h-[120vmin] -translate-x-1/2 
      -translate-y-1/2 text-[#710523]
      "/>
...
<div className=
"text-area relative mx-auto text-center">
...
function ArrowButton({label, onClick, direction="right"}:ArrowButtonProps){
  return (
    ...
    onClick={onClick} 
      ...
      focus-visible:ring-4 md:size-16 lg:size-28">
